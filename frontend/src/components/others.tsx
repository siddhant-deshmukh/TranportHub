...
export function Spinner({ size }: {
  ...
  return <div role="status">
    <svg aria-hidden="true" className={`w-${(size)?size:8} aspect-square mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
